...
### Out of scope :)
- Threading. App perform everything on main thread without any respect to UI locking. Obviously in real world all work should be done in background and cached.
- UI. Built with storyboards and wired together via notifications. Kinda oldschool.
